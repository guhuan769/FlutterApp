...
import com.elon.camera_photo_system.data.repository.ModelTypeRepositoryImpl
import com.elon.camera_photo_system.data.repository.PhotoRepositoryImpl
import com.elon.camera_photo_system.data.repository.ProcessTypeRepositoryImpl
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideModelTypeDao(database: AppDatabase): ModelTypeDao {
        return database.modelTypeDao()
    }
    ...
    @Provides
    @Singleton
    fun provideModelTypeRepository(modelTypeDao: ModelTypeDao): ModelTypeRepository {
        return ModelTypeRepositoryImpl(modelTypeDao)
    }
    
    @Provides
    @Singleton
    fun provideProcessTypeRepository(processTypeDao: ProcessTypeDao): ProcessTypeRepository {
        return ProcessTypeRepositoryImpl(processTypeDao)
    }
} 