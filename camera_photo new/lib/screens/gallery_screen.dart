...
class _GalleryScreenState extends State<GalleryScreen> {
  ...
  Widget _buildPhotoItem(BuildContext context, File photo, bool isSelected, int index, PhotoProvider provider) {
    ...
    final photoType = fileNameParts[0]; // 拍照类型（起始点/中间点等）
    final timestamp = fileNameParts.length > 1 ? fileNameParts[1].replaceAll('.jpg', '') : ''; // 时间戳
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildPhotoItem(
                      context, photo, isSelected, index, provider);
                },
              ),
            // 上传进度指示器
